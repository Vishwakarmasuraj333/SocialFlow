...
export default function PlatformsPage() {
  ...
  const platformMatrix = [
    ...
    },
    {
      ...
      name: "WhatsApp",
      category: "community",
      api: "WhatsApp Cloud API v19.0",
      badgeColor: "bg-emerald-500/10 text-emerald-400 border-emerald-500/20",
      accent: "#25D366",
      glow: "hover:border-[#25D366]/60 hover:shadow-[0_0_35px_rgba(37,211,102,0.25)]",
      charLimit: 1000,
      maxImages: 10,
      images: true,
      video: true,
      ...
      analytics: true,
      directPublish: true,
      notes: "Official Meta WhatsApp Cloud API for broadcasting to verified brand channels, media dispatch, and subscriber notifications.",
    },
    {
      key: "telegram",
      name: "Telegram",
      ...
      accent: "#26A5E4",
      glow: "hover:border-[#26A5E4]/60 hover:shadow-[0_0_35px_rgba(38,165,228,0.25)]",
      charLimit: 4096,
      maxImages: 10,
      images: true,
      video: true,
      ...
      analytics: true,
      directPublish: true,
      notes: "Direct channel broadcasting with rich Markdown formatting, photo albums, video uploads, and pinned announcement dispatches.",
    },
    {
      key: "discord",
      name: "Discord",
      ...
      accent: "#5865F2",
      glow: "hover:border-[#5865F2]/60 hover:shadow-[0_0_35px_rgba(88,101,242,0.25)]",
      charLimit: 2000,
      maxImages: 10,
      images: true,
      video: true,
      ...
      analytics: false,
      directPublish: true,
      notes: "Automated community announcements with rich embedded cards, color-coded callouts, thumbnail previews, and role mentions.",
    },
    {
      key: "reddit",
      name: "Reddit",
      ...
      accent: "#FF4500",
      glow: "hover:border-[#FF4500]/60 hover:shadow-[0_0_35px_rgba(255,69,0,0.25)]",
      charLimit: 40000,
      maxImages: 20,
      images: true,
      video: true,
      ...
      analytics: true,
      directPublish: true,
      notes: "Official Subreddit link and text post submissions with flair assignments, spoiler flags, and karma/comment monitoring.",
    },
    {
      key: "bluesky",
      name: "Bluesky",
      category: "publishing",
      api: "AT Protocol v1 (atproto)",
      badgeColor: "bg-blue-400/10 text-blue-400 border-blue-400/20",
      accent: "#0085FF",
      glow: "hover:border-[#0085FF]/60 hover:shadow-[0_0_35px_rgba(0,133,255,0.25)]",
      charLimit: 300,
      maxImages: 4,
      images: true,
      video: false,
      ...
      analytics: true,
      directPublish: true,
      notes: "Decentralized AT Protocol integration for skeets, link card facets, high-resolution photo attachments, and federated thread tracking.",
    },
    {
      key: "mastodon",
      name: "Mastodon",
      category: "publishing",
      api: "ActivityPub REST API v2",
      badgeColor: "bg-indigo-400/10 text-indigo-400 border-indigo-400/20",
      accent: "#6364FF",
      glow: "hover:border-[#6364FF]/60 hover:shadow-[0_0_35px_rgba(99,100,255,0.25)]",
      charLimit: 500,
      maxImages: 4,
      images: true,
      video: true,
      ...
      analytics: true,
      directPublish: true,
      notes: "Fediverse publishing across custom server instances with content warnings, alt-text tags, polls, and federated reply tracking.",
    },
    {
      key: "tumblr",
      name: "Tumblr",
      ...
      accent: "#36465D",
      glow: "hover:border-[#36465D]/60 hover:shadow-[0_0_35px_rgba(54,70,93,0.25)]",
      charLimit: 4096,
      maxImages: 10,
      images: true,
      video: true,
      ...
      analytics: true,
      directPublish: true,
      notes: "Multi-blog microblogging with HTML/Markdown rendering, custom tags, photo photo-sets, and reblog synchronization.",
    },
    {
      key: "medium",
      name: "Medium",
      ...
      badgeColor: "bg-slate-600/10 text-slate-300 border-slate-600/20",
      accent: "#000000",
      glow: "hover:border-slate-400/60 hover:shadow-[0_0_35px_rgba(0,0,0,0.25)]",
      charLimit: 50000,
      maxImages: 20,
      images: true,
      video: true,
      ...
      analytics: true,
      directPublish: true,
      notes: "Longform publication dispatch with canonical URL attribution, SEO meta tags, publication submission, and publication drafts.",
    },
    {
      key: "quora",
      name: "Quora",
      category: "publishing",
      api: "Quora Spaces API v1",
      badgeColor: "bg-red-600/10 text-red-400 border-red-600/20",
      accent: "#B92B27",
      glow: "hover:border-[#B92B27]/60 hover:shadow-[0_0_35px_rgba(185,43,39,0.25)]",
      charLimit: 10000,
      maxImages: 5,
      images: true,
      video: false,
      ...
      analytics: true,
      directPublish: true,
      notes: "Knowledge Space broadcasting, thought-leadership post publishing, and community engagement telemetry.",
    },
    {
      key: "wordpress",
      name: "WordPress",
      ...
      badgeColor: "bg-sky-600/10 text-sky-400 border-sky-600/20",
      accent: "#21759B",
      glow: "hover:border-[#21759B]/60 hover:shadow-[0_0_35px_rgba(33,117,155,0.25)]",
      charLimit: 100000,
      maxImages: 50,
      images: true,
      video: true,
      ...
      analytics: true,
      directPublish: true,
      notes: "Direct publishing to self-hosted WordPress and VIP sites with featured image media upload, categories, tags, and status drafts.",
    },
    {
      key: "vimeo",
      name: "Vimeo",
      category: "visual",
      api: "Vimeo API v3.4 (tus upload)",
      badgeColor: "bg-sky-400/10 text-sky-400 border-sky-400/20",
      accent: "#1AB7EA",
      glow: "hover:border-[#1AB7EA]/60 hover:shadow-[0_0_35px_rgba(26,183,234,0.25)]",
      charLimit: 5000,
      maxImages: 1,
      images: true,
      video: true,
      ...
      analytics: true,
      directPublish: true,
      notes: "High-bitrate 4K video upload via resumable tus protocol with privacy access rules, custom thumbnails, and video analytics.",
    },
    {
      key: "snapchat",
      name: "Snapchat",
      ...
      badgeColor: "bg-yellow-400/10 text-yellow-300 border-yellow-400/20",
      accent: "#FFFC00",
      glow: "hover:border-yellow-400/60 hover:shadow-[0_0_35px_rgba(255,252,0,0.25)]",
      charLimit: 250,
      maxImages: 1,
      images: true,
      video: true,
      ...
      analytics: true,
      directPublish: true,
      notes: "Snap Spotlight and Public Story dispatch with attachment links, captions, and creator telemetry.",
    },
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="mt-4 text-base sm:text-lg text-slate-600 dark:text-slate-300 leading-relaxed">
              We connect exclusively through certified official partner APIs. Here is the verified, production-level capability breakdown for all 20 social networks.
            </p>

            {/* Filter Tabs */}
            <div className="mt-8 inline-flex flex-wrap justify-center items-center gap-1.5 p-1.5 rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-100/80 dark:bg-slate-900/80 backdrop-blur-md">
              {[
                { id: "all", label: "All Networks (20)" },
                { id: "professional", label: "B2B & Professional" },
                { id: "visual", label: "Visual & Video" },
                { id: "community", label: "Messaging & Community" },
                { id: "publishing", label: "Publishing & Fediverse" },
              ].map((tab) => (
                <button
                  key={tab.id}
